        ...
        <section className="py-16 reveal-section">
          <div className="container">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="glass-morphism h-24 rounded-xl flex items-center justify-center px-6 py-4">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex">
                    <div className="h-10 w-10 rounded-full bg-brand-accent/20 flex items-center justify-center text-brand-accent font-bold mr-4 flex-shrink-0">1</div>
                    <div>
                  ...
                  <div className="flex">
                    <div className="h-10 w-10 rounded-full bg-brand-accent/20 flex items-center justify-center text-brand-accent font-bold mr-4 flex-shrink-0">2</div>
                    <div>
                  ...
                  <div className="flex">
                    <div className="h-10 w-10 rounded-full bg-brand-accent/20 flex items-center justify-center text-brand-accent font-bold mr-4 flex-shrink-0">3</div>
                    <div>
                ...
                <Button 
                  className="mt-8 bg-brand-accent hover:bg-brand-accent/90 text-white rounded-full px-6 py-5 text-base font-medium group"
                >
                  Learn More
              ...
              <div className="relative">
                <div className="absolute -top-10 -left-10 w-64 h-64 rounded-full bg-brand-accent/5 blur-3xl"></div>
                <div className="glass-morphism rounded-2xl p-8 relative">
                  <div className="aspect-square bg-gradient-to-br from-teal-400 to-brand-accent rounded-xl mb-6 flex items-center justify-center">
                  ...
                  <Button className="w-full bg-brand-accent hover:bg-brand-accent/90 rounded-lg">
                    Get Started
                  </Button>
                </div>
              </div>
        ...
        <section className="py-16 reveal-section">
          <div className="container">
            <div className="text-center">
              ...
              <Button className="bg-brand-accent hover:bg-brand-accent/90 text-white rounded-full px-8 py-6 text-lg font-medium">
                GET LEADS
              </Button>
            </div>
          </div>
